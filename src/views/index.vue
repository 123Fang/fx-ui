<template>
  <div class="contentBox">
    <div class="imgLogo">
      <img src="../assets/logo.jpeg" alt="fx-ui" />
    </div>
    ...
    <div class="tiBox">
      ...
      <div class="buttonGroups">
        <fx-button type="primary" round style="padding: 15px 50px; margin-right: 2vw; font-size: 17px"
          @click="toComponents">立即上手</fx-button>
        <fx-button round icon="fx-icon-github" style="padding: 15px 50px; margin-left: 2vw; font-size: 17px"
          @click="goGuthub">Github</fx-button>
      </div>
      <div class="cardBox">
        <li>
          <p>更小的体积</p>
      ...
      <div class="links">
        ...
        <li v-for="(item, index) in devoteList" :key="index" title="点击跳转至Ta的Github主页" @click="toDevoteGithub(item)">
          <div class="">
            ...
            <span :style="{ color: item.name == '123Fang' ? '#000' : '' }">{{
              item.name
            }}</span>
          </div>
        </li>
...
const state = reactive({
  devoteList: [
    {
      name: "123Fang",
      github: "https://github.com/123Fang",
      img: "https://avatars.githubusercontent.com/u/38906235?v=4",
    }
  ],
});
const toComponents = () => {
...
const goGuthub = () => {
  window.open("https://github.com/123Fang/fx-ui");
};
const goToNpm = () => {
  // window.open("");
};
const verSion = () => {
  router.push("/fx/updatelog");
};

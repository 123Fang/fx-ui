<template>
  <transition name="fade-pupop">
    <div class="fx-loading" v-if="obj.show" :style="{'position':obj.position,'background-color':obj.bgColor}">
      <div :style="{color:obj.textColor}" class="fx-loading-center">

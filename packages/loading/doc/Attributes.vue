   ...
   fileds:[
    ...
    datas:[
      {attr:'text',type:'String',red:'加载文字',sel:'——',def:"加载中..."},
        {attr:'icon',type:'String',red:'加载状态图标',sel:'fx-icon-loading1 / fx-icon-loading2 / fx-icon-loading3 / fx-icon-loading4 / fx-icon-loading5 / fx-icon-loading6',def:"fx-icon-loading1"},

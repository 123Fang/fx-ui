<template>
  <fx-table :options="options"></fx-table>
</template>
...
const state = reactive({
  options:{
    ...
    datas:[
      ...
      {attr:'loading',type:'Boolean',red:'是否为加载状态的按钮，加载状态的icon仅支持这六个(fx-icon-loading1 / fx-icon-loading2 / fx-icon-loading3 / fx-icon-loading4 / fx-icon-loading5 / fx-icon-loading6)，通过 leftIcon / rightIcon 参数配置并确定位置',sel:'true / false ',def:"false"},

<template>
  <div class="fx-menu-div-box" :style="{ width: index != 0 ? '100%' : '' }">
    <li
    ...
    >
      <div class="fx-menu-item-title-box">
...
const iconClass = computed(() => {
  return {
    "fx-icon-arrow-down-bold": props.index == 0,
    "fx-icon-arrow-right": props.index != 0,
